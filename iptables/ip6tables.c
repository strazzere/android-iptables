...
void ip6tables_xtables_error(enum xtables_exittype status, const char *msg, ...) __attribute__((noreturn, format(printf,2,3)));
struct xtables_globals ip6tables_globals = {
	.option_offset = 0,
	.program_version = PACKAGE_VERSION,
	.orig_opts = original_opts,
	.exit_err = ip6tables_xtables_error,
...
void
ip6tables_xtables_error(enum xtables_exittype status, const char *msg, ...)
{
	va_list args;
