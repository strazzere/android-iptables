...
void xtables_xtables_error(enum xtables_exittype status, const char *msg, ...) __attribute__((noreturn, format(printf,2,3)));

struct xtables_globals xtables_globals = {
	.option_offset = 0,
	.program_version = PACKAGE_VERSION,
	.orig_opts = original_opts,
	.exit_err = xtables_xtables_error,
...
void
xtables_xtables_error(enum xtables_exittype status, const char *msg, ...)
{
	va_list args;
